...
class JSONWriterTest
{
	...
	void testArrayWrite()
	{
		final JSONValue[] simple = { JSONBooleanValue.TRUE, null, new JSONStringValue("Testing\t123"), JSONNullValue.NULL, new JSONNumberValue(-34.2) };
		...
		testTemplate(empty, "[]");
		testTemplate(simVal, "[true,null,\"Testing\\t123\",null,-34.2]");
		testTemplate(comVal, "[[true,null,\"Testing\\t123\",null,-34.2],null,{\"empty\":\"\",\"text\":\"Test\",\"bool\":false,\"arr\":[true,null,\"Testing\\t123\",null,-34.2]},12.0,[\"This\",\"is\",\"inner\",\"array\"],[],true]");
	}
	...
	void testObjectWrite()
	{
		...
		no.setField("text", "Examp\ne");
		no.setField("bottom", "Text");
		no.setField("test", "Bottom\\");
		no.setField("bad", obj);
		obj.setField("inner", no);
		testTemplate(val, "{\"empty\":\"\",\"inner\":{\"text\":\"Examp\\ne\",\"bottom\":\"Text\",\"test\":\"Bottom\\\\\"},\"text\":\"Test\\u0003\",\"obj\":{},\"bool\":false,\"\":null,\"arr\":[true,null,\"Testing\",null,-34.2]}");
	}
}
